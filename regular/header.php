...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="./display_product_regular.php">Menu</a>
        ...
        <nav class="icons">
            ...
            <div class="dropdown_user">
                ...
                <ul class="dropdown">
                    <li><a href="./register-login.php" id="login-btn" onclick="login()">Login</a></li>
                    <li><a href="./register-login.php" id="register-btn" onclick="register()">Register</a></li>
                </ul>
            </div>
